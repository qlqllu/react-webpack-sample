  ...
  render() {
    ...
    return <div>
      <div>
        ...
        2. The owner component re-render will always re-render the ownee non-pure component, even there is no property change if we don't check in shouldComponentUpdate()<br/>
